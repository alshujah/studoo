...
const journalModules = [
    ...
    { href: "/track/journal/freeform", title: "Self-Compassion Journal", description: "Focus on kindness and understanding towards yourself." },
    ...
    { href: "/track/journal/freeform", title: "Future Self Journaling", description: "Write to your future self to build hope." },
    { href: "/track/journal/freeform", title: "Expressive Writing", description: "Write about traumatic or stressful events." },
    { href: "/track/journal/freeform", title: "Sentence Completion", description: "Journal prompts to guide reflection." },
    { href: "/track/journal/freeform", title: "Story-Based Journaling", description: "Write about your life as a story." },
