...
const journalModules = [
    ...
    { href: "#", title: "Future Self Journaling", description: "Write to your future self to build hope." },
    { href: "#", title: "Expressive Writing", description: "Write about traumatic or stressful events." },
    { href: "#", title: "Sentence Completion", description: "Journal prompts to guide reflection." },
    { href: "#", title: "Story-Based Journaling", description: "Write about your life as a story." },
    { href: "#", title: "Unsent Letter", description: "Write a letter you don't intend to send." },
    { href: "#", title: "Role-Playing Journal", description: "Explore situations from different perspectives." },
    { href: "#", title: "Automatic Thought Recording", description: "Quickly capture automatic thoughts." },
    { href: "#", title: "Post-Traumatic Growth Exercises", description: "Focus on growth after trauma." },
];
