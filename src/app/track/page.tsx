...
const trackingModules = [
    ...
    { href: "#", title: "Burnout Symptom Tracking", description: "Monitor signs of burnout." },
    { href: "#", title: "Self-Esteem Fluctuations", description: "Track your self-esteem over time." },
    { href: "#", title: "Weather Correlation", description: "Track mood changes with the weather." },
    { href: "#", title: "Medication Interaction Checker", description: "Check for interactions between medications." },
    { href: "#", title: "Symptom Severity Scoring", description: "Score the severity of your symptoms." },
