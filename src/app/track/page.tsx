...
const trackingModules = [
    ...
    { href: "/tools/dbt/distress-tolerance", title: "Thought Stopping Techniques", description: "Learn to stop unwanted thoughts." },
    ...
    { href: "/tools/ipt/social-skills-assessment", title: "Coping Style Evaluation", description: "Evaluate your coping self-efficacy." },
