...
const toolCategories = [
    ...
    { title: "Schema Therapy", description: "Change long-term patterns.", icon: Puzzle },
    { title: "SFBT", description: "Solution-Focused Brief Therapy.", icon: Target },
    { title: "Narrative Therapy", description: "Rewrite your story.", icon: BookText },
    ...
    { title: "Somatic Therapy", description: "Body-based trauma release.", icon: PersonStanding },
    ...
    { title: "Psychodynamic", description: "Explore unconscious patterns.", icon: Drama },
    ...
    <PageLayout title="All Tools">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {toolCategories.map((category) => {
            ...
            if ((category as any).href) {
                return (
                    <Link href={(category as any).href} key={category.title} className="block hover:bg-muted/50 rounded-lg">
                        {card}
                    </Link>
                )
            }
