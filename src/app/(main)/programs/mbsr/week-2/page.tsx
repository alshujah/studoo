...
export const metadata: Metadata = {
  title: 'Week 2 | MBSR Program | Zenith Wellness',
};

export default function MbsrWeek2Page() {
  return (
    <PageLayout title="Week 2: Coming Soon">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Content for Week 2 is being developed.</CardTitle>
                <CardDescription>
