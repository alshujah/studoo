...
export const metadata: Metadata = {
  title: 'Week 4 | MBSR Program | Zenith Wellness',
};

export default function MbsrWeek4Page() {
  return (
    <PageLayout title="Week 4: Coming Soon">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Content for Week 4 is being developed.</CardTitle>
                <CardDescription>
