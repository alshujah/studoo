...
export const metadata: Metadata = {
  title: 'Week 5 | MBSR Program | Zenith Wellness',
};

export default function MbsrWeek5Page() {
  return (
    <PageLayout title="Week 5: Coming Soon">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Content for Week 5 is being developed.</CardTitle>
                <CardDescription>
