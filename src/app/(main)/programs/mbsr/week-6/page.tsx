...
export const metadata: Metadata = {
  title: 'Week 6 | MBSR Program | Zenith Wellness',
};

export default function MbsrWeek6Page() {
  return (
    <PageLayout title="Week 6: Coming Soon">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Content for Week 6 is being developed.</CardTitle>
                <CardDescription>
