...
export const metadata: Metadata = {
  title: 'Week 8 | MBSR Program | Zenith Wellness',
};

export default function MbsrWeek8Page() {
  return (
    <PageLayout title="Week 8: Coming Soon">
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Content for Week 8 is being developed.</CardTitle>
                <CardDescription>
