export const characterStrengths = [
    {
        name: "Creativity",
        description: "Thinking of new and productive ways to conceptualize and do things."
    },
    {
        name: "Curiosity",
    ...
    },
    {
        ...
        description: "Mastering new skills, topics, and bodies of knowledge, whether on one's own or formally."
    },
    {
        name: "Perspective",
    ...
    {
        name: "Bravery",
        description: "Not shrinking from threat, challenge, difficulty, or pain; speaking up for what's right even if there's opposition."
    },
    {
        name: "Perseverance",
    ...
    {
        name: "Honesty",
        description: "Speaking the truth but more broadly presenting oneself in a genuine way and acting in a sincere way; being without pretense."
    },
    {
        name: "Zest",
        description: "Approaching life with excitement and energy; not doing things halfway or halfheartedly; living life as an adventure."
    },
    {
        name: "Love",
        description: "Valuing close relations with others, in particular those in which sharing and caring are reciprocated."
    },
    {
        name: "Kindness",
    ...
    {
        name: "Fairness",
        description: "Treating all people the same according to notions of fairness and justice; not letting feelings bias decisions about others."
    },
    {
        name: "Leadership",
    ...
    {
        name: "Forgiveness",
        description: "Forgiving those who have done wrong; accepting others' shortcomings; giving people a second chance."
    },
    {
        name: "Humility",
    ...
    },
    {
        ...
        description: "Noticing and appreciating beauty, excellence, and/or skilled performance in various domains of life."
    },
    {
        name: "Gratitude",
    ...
    {
        name: "Spirituality",
        description: "Having coherent beliefs about the higher purpose and meaning of the universe; knowing where one fits in the larger scheme."
    }
];
