...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful AI assistant for a mental health app. A user has described their current issue. Your task is to recommend the single most appropriate tool from the provided list to help them.
